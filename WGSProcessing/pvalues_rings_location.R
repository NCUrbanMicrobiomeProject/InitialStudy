...
infpce<-infpce[infpce$pValuesLocationAdjusted<0.05 ,]
...
pceate<-pceate[pceate$pValuesLocationAdjusted<0.05  ,]
...
atefce<-atefce[atefce$pValuesLocationAdjusted<0.05  ,]
...
inffce<-inffce[inffce$pValuesLocationAdjusted<0.05  ,]
...
fcedsa<-fcedsa[fcedsa$pValuesLocationAdjusted<0.05  ,]
...
fcedsb<-fcedsb[fcedsb$pValuesLocationAdjusted<0.05  ,]
...
dsadsb<-dsadsb[dsadsb$pValuesLocationAdjusted<0.05 ,]
...
fceds<-fceds[fceds$pValuesLocationAdjusted<0.05  ,]
...
updown<-updown[updown$pValuesLocationAdjusted<0.05  ,]
...
hospres<-hospres[hospres$pValuesLocationAdjusted<0.05  ,]
...
write.table(rings, file= "pvalues_location_rings_colors.txt", row.names = F, sep ="\t")
