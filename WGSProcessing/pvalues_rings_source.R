...
#infpce<-infpce[infpce$pValuesPceInfAdjusted<0.05, ]
...
pceate<-pceate[pceate$pValuesPceAteAdjusted<0.05 ,]
...
#atefce<-atefce[atefce$pValuesFceAteAdjusted<0.05 ,]
...
inffce<-inffce[inffce$pValuesFceInfAdjusted<0.05 ,]
...
fcedsa<-fcedsa[fcedsa$pValuesFCEDownAdjusted<0.05 ,]
...
fcedsb<-fcedsb[fcedsb$pValuesFCEDownAdjusted<0.05 ,]
...
#dsadsb<-dsadsb[dsadsb$pValuesdsAdsBAdjusted<0.05 ,]
...
fceds<-fceds[fceds$pValuesFCEDownAdjusted<0.05, ]
...
updown<-updown[updown$pValuesUpDownAdjusted<0.05 ,]
...
hospres<-hospres[hospres$pValuesHospResAdjusted<0.05 ,]
...
write.table(rings, file= "pvalues_source_rings_colors.txt", row.names = F, sep ="\t")
