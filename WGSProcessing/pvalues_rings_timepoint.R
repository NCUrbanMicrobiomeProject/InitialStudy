...
infpce<-infpce[infpce$pValuesTimepointAdjusted<0.05 ,]
...
pceate<-pceate[pceate$pValuesTimepointAdjusted<0.05  ,]
...
atefce<-atefce[atefce$pValuesTimepointAdjusted<0.05  ,]
...
inffce<-inffce[inffce$pValuesTimepointAdjusted<0.05  ,]
...
fcedsa<-fcedsa[fcedsa$pValuesTimepointAdjusted<0.05  ,]
...
fcedsb<-fcedsb[fcedsb$pValuesTimepointAdjusted<0.05  ,]
...
dsadsb<-dsadsb[dsadsb$pValuesTimepointAdjusted<0.05 ,]
...
fceds<-fceds[fceds$pValuesTimepointAdjusted<0.05  ,]
...
updown<-updown[updown$pValuesTimepointAdjusted<0.05  ,]
...
hospres<-hospres[hospres$pValuesTimepointAdjusted<0.05  ,]
...
write.table(rings, file= "pvalues_timepoint_rings_colors.txt", row.names = F, sep ="\t")
